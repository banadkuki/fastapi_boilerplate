...
```
cd existing_repo
git remote add origin https://gitlab.ecoex.ir/phinix/finance/services.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ecoex.ir/phinix/finance/services/-/settings/integrations)
